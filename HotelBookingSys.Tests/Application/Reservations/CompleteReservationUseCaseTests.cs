...
public class CompleteReservationUseCaseTests
{
    ...
    public async Task ExecuteAsync_WhenReservationNotFound_ReturnsNotFound()
    {
        ...
        var useCase = new CompleteReservationUseCase(reservationRepo.Object, roomRepo.Object);
    ...
    public async Task ExecuteAsync_WithValidReservation_ReturnsSuccess()
    {
        ...
        result.Value?.Status.Should().Be(ReservationStatus.Completed.ToString());
